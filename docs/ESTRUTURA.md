...
- **LLM para plano de ação — Gemini 2.5 Pro (Google):** gera o `action_plan` a partir dos segmentos recuperados. Motivo: contexto muito longo (vários trechos de transcrição) com raciocínio forte e custo baixo (~US$1.25/Mtok in), ideal para consolidar insights de múltiplos vídeos. Para volume alto de buscas simultâneas com resposta imediata, **Gemini 3.5 Flash** (~US$0.30/Mtok in) é a alternativa custo-eficiente.
