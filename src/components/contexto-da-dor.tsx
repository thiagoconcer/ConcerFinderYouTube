 ...
 *
 * Duas decisões de tela que valem mais que o texto:
 *
 * A caixa NÃO segura o plano. Ela aparece enquanto o plano está sendo gerado
 * com o que já existe. Quem ignora recebe o plano de sempre; quem responde
 * recebe um plano reescrito com o contexto. Nunca há tela vazia esperando
 * resposta, que era o risco de transformar isto num formulário obrigatório.
 *
